...
const CATEGORIES = ['SEO', 'Social Media', 'Email Marketing', 'Analytics', 'Content', 'Advertising', 'Other']
...
export default function MarketingResourcesPage() {
  ...
  const loadResources = () => {
    const stored = localStorage.getItem('chromara-marketing-resources')
    if (stored) {
  ...
  const saveResources = (newResources: Resource[]) => {
    ...
    localStorage.setItem('chromara-marketing-resources', JSON.stringify(newResources))
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white">Marketing Resources 📢</h1>
          <p className="text-white/60 mt-1">SEO, social media, email, analytics, and more</p>
        </div>
